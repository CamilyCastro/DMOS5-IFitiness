...
class UsersRepository (application: Application) {
    ...
    fun load(userId: String) : MutableLiveData<User?> {
    ...
    companion object {
        ...
        const val KEY = "?key=....." // pegar nas Configurações do Projeto no Firebase - valor parecido com AIzaSyBxFjit4FD8NN5Mx8hTFQQxeVA1Pv2OUag
